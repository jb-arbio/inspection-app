...
export const PMS = {
  ...
  fv_building_amenities_verify: 'equipmentAndAmenities.name',
  ...
  fv_capacity_base: 'profile.baseCapacity  [NEW — confirm in hub]',
  fv_capacity_max: 'profile.maxCapacity  [NEW — confirm in hub]',
  ...
  item_kind: 'equipmentAndAmenities.kind',
  ...
  item_video: 'equipmentAndAmenities.videoUrl  [proposed]',
  ...
  fv_blackout_curtains: 'equipmentAndAmenities.name  [amenity entry]',
