...
// RAW is now used ONLY by CONFIG_META (version/generated_at/source_file/counts).
// The survey itself is composed from editable content + a structural overlay
// (see below); the transform chain that used to build PHASES from RAW.phases
// has been replaced by buildSurveyConfig().
